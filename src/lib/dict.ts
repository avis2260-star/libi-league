...
export const DICT: Record<string, string> = {
  ...
  // Cup brackets / journey
  'טורניר הגביע': 'Cup Tournament',
  'הנתונים יופיעו לאחר סנכרון קובץ האקסל': 'Data will appear after Excel file sync',
  'הגמר': 'The Final',
  'תאריך טרם נקבע': 'Date TBD',
  'אלוף': 'Champion',
  'הושלם ✓': 'Completed ✓',
  '● פעיל': '● Active',
  'משחק': 'game',
  'אלוף הגביע 2025–2026': 'Cup Champion 2025–2026',
  'אלוף הגביע': 'Cup Champion',
  'טרם נקבע — ממתין לגמר': 'TBD — awaiting final',
  'משחק בית': 'Home game',
  'משחק חוץ': 'Away game',
  'מגרש ניטרלי': 'Neutral court',
  'משחקים נותרו': 'games left',
  'מסע בגביע': 'Cup Journey',
  'הודחה ב': 'Eliminated in ',
  'מתחילה את הדרך ב': 'Starting in ',
  'בדרך ל': 'heading to ',
  '🏆 אלופת הגביע!': '🏆 Cup Champion!',
  'בבית': 'at home',
  'בחוץ': 'away',
  'ניצחון': 'Win',
  'הפסד': 'Loss',
  ...
  'תפגוש את ': 'will face ',
  'מול ': 'vs ',
  'אין משחקים לקבוצה זו': 'No games for this team',
  'חזרה לטורניר': 'Back to Tournament',
  ...
  // Team names (and their alias variants used across tables)
  'ידרסל חדרה': 'Edersal Hadera',
  'כח עולה בת ים': 'Koach Ole Bat Yam',
  ...
  'ה.ה. גדרה': 'The Good Guys Gedera',
  'אחים קריית משה': 'Achim Kiryat Moshe',
  'אחים קרית משה': 'Achim Kiryat Moshe',
  'בני נתניה': 'Bnei Netanya',
  'גלי בת ים': 'Gali Bat Yam',
  'גלי בת-ים': 'Gali Bat Yam',
  'חולון': 'Holon',
  ...
  'א.ט. ק. גת': 'A.T. Kiryat Gat',
  'א.ס. ק. גת': 'A.T. Kiryat Gat',
  'אריות קריית גת': 'A.T. Kiryat Gat',
  'אריות ק. גת': 'A.T. Kiryat Gat',
